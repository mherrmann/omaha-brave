...
const TCHAR* const kUrlUpdateCheck =
    _T("https://updates-dev.brave.software/service/update2");
...
const TCHAR* const kUrlCrashReport =
    _T("https://updates-dev.brave.software/cr/report");

// More information url.
// Must allow query parameters to be appended to it.
const TCHAR* const kUrlMoreInfo =
    _T("https://updates-dev.brave.software/support/installer/?");

// Code Red check url.
const TCHAR* const kUrlCodeRedCheck =
    _T("https://updates-dev.brave.software/service/check2");

// Usage stats url.
const TCHAR* const kUrlUsageStatsReport =
    _T("https://updates-dev.brave.software/tbproxy/usagestats");
